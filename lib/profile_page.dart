...
class _ProfilePageState extends State<ProfilePage> {
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            final TextEditingController _heightController = TextEditingController(text: userData['Height']);
            final TextEditingController _weightController = TextEditingController(text: userData['Weight']);
  ...
  Future<void> updateData(String name, String email, String height, String weight) async {
